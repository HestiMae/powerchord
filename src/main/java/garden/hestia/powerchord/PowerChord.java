...
public class PowerChord implements ModInitializer {
    ...
    public static final Item SPIRIT_ARMADILLO = Registry.register(Registries.ITEM, Identifier.of(ID, "spirit_armadillo"), new Item(new Item.Settings().maxCount(1).component(KEY,
    ...
    public static final Item SPIRIT_BAT = Registry.register(Registries.ITEM, Identifier.of(ID, "spirit_bat"), new Item(new Item.Settings().maxCount(1).component(KEY,
        new PowerKeyComponent(SoundEvents.BLOCK_NOTE_BLOCK_CHIME.value(), Progressions.Bb1547)))
    );

    public static final Item SPIRIT_CAT = Registry.register(Registries.ITEM, Identifier.of(ID, "spirit_cat"), new Item(new Item.Settings().maxCount(1).component(KEY,
        new PowerKeyComponent(SoundEvents.BLOCK_NOTE_BLOCK_BASS.value(), Progressions.C1546)))
    );

    public static final Item SPIRIT_DOG = Registry.register(Registries.ITEM, Identifier.of(ID, "spirit_dog"), new Item(new Item.Settings().maxCount(1).component(KEY,
        new PowerKeyComponent(SoundEvents.BLOCK_NOTE_BLOCK_BASS.value(), Progressions.D1546)))
    );

    public static final Item SPIRIT_CHAMELEON = Registry.register(Registries.ITEM, Identifier.of(ID, "spirit_chameleon"), new Item(new Item.Settings().maxCount(1).component(KEY,
