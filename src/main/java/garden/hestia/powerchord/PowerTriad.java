...
public record PowerTriad(int root, int third, int fifth, Text name, AoeEffect effect) implements PowerableChord {
    public static final Codec<PowerTriad> CODEC = RecordCodecBuilder.create(instance -> instance.group(
        ...
        AoeEffect.CODEC.fieldOf("effect").forGetter(PowerTriad::effect)
